...
Die Lösung des wise men Rätsels benötigt folglich zwei Schritte \vglHuth{S. 342f}.
...
Die \LNs{1-5} beschreiben die Vorgaben, das Grundwissen, das bereits auf dem Umgangssprachlichen Text extrahier wurde.\\
...
Die \LNs{15-17} zeigen den daraus folgenden Widerspruch an was die Annahme aus \LN{7} widerlegt woraus nach anwenden der De-Morgen-Regel in \LN{18} die gewünschte Aussage bewiesen ist, die, weil alles im Bereich des Allgemeinwissens geführt wurde, ebenfalls zum Allgemeinwissen zählen \underline{muss}.
...
\begin{figure}[h!t]
	...
	\end{equation*}
	\caption{Schritt 01 des three wise men Rätsels \\ Quelle: \citeHuth{S. 345}}
...
\begin{figure}[h!t]
	...
	\end{equation*}
	\caption{Schritt 02 des three wise men Rätsels \\ Quelle: \citeHuth{S. 346}}
