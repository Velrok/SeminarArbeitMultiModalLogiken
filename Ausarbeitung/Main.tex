...
\documentclass[a4paper, headsepline, footsepline]{scrbook}
%\documentclass[a4paper, headsepline, footsepline]{scrreprt}
...
% bugfix: 
%http://groups.google.com/group/dot2tex-users/browse_thread/thread/91b8d9191553e526
%\@ifundefined{verbatim@out}{\newwrite\verbatim@out}{}% 


\usepackage{dsfont}			% funny math Letters
\usepackage{ulem}				% strike out fonts
\usepackage{rotating}		% rotated table text
