...
Ein Beispiel für eine notwendigerweise wahre Aussage ist \emph{''ein Junggeselle ist unverheiratet''}. Den ein Junggestellen ist per Definition unverheiratet, es ist genau diese Eigenschaft, die ihn zum Junggestellen macht. \vglHuth{S. 306}.
...
Einfache Logiken modellieren nur eine Modalität von Wahrheit, z.B. notwendigerweise wahr, komplizierte Logiken modellieren auch mehrere, z.B. wahr nach allem was Agent $i$ weiß, für $ 0 < i < k$ \vglHuth{S.306f}.\\
