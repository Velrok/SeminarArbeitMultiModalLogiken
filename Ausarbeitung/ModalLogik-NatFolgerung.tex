...
Die \Eq{iConjunction} ist ein Beispiel für eine Einführungsregel.
...
Dafür werden blaue Boxen als neues Syntax-Element eingeführt, siehe \Eq{iBox} und \Eq{eBox}.
Die blaue Box steht für das \emph{Folgern in einer beliebigen erreichbaren Welt}.\\
Eine blaue Box erlaubt es die Formel $\phi$ in eine blaue Box zu verwenden wenn es vorher die Formel $\Box \phi$ gab \vglHuth{S. 328ff}.
...
\Eq{kt45_deduc_rules} beschreibt die extra Regeln für die \ML $KT45$.
