...
\newcommand{\LN}[1]{Zeile #1 }
\newcommand{\LNs}[1]{Zeilen #1 }

\newcommand{\vglHuth}[1]{(vgl. \cite[#1]{huth2004logic}) }
\newcommand{\citeHuth}[1]{\cite[#1]{huth2004logic} }

\newcommand{\vglPriest}[1]{(vgl.~\cite[#1]{Priest:2008}) }
\newcommand{\citePriest}[1]{Priest~\cite[#1]{Priest:2008} }
...
\newcommand{\NNML}{Nicht-Normale-Modal-Logik }
\newcommand{\NNMLn}{Nicht-Normale-Modal-Logiken }
...
\newcommand{\EQRef}{Äquivalentz-Relation }

\newcommand{\formelSchema}{Formel-Schema }
\newcommand{\formelSchemas}{Formel-Schemas }
\newcommand{\formelSchemata}{Formel-Schemata }
\newcommand{\formelSchematas}{Formel-Schematas }
...
\newcommand{\KMs}{Kripke-Models }
\newcommand{\KMn}{Kripke-Modellen }

\newcommand{\MAS}{Multi-Agent-Systeme }
\newcommand{\MASn}{Multi-Agent-Systemen }

\newcommand{\WMR}{\emph{Wise-Men-Rätsel} }
\newcommand{\WMRs}{\emph{Wise-Men-Rätsels} }
