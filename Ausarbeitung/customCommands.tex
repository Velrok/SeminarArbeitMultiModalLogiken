...
\newcommand{\Ref}[1]{\ref{#1} auf Seite \pageref{#1} }
...
\newcommand{\Theo}[1]{Theorem~\eqref{theo:#1} auf Seite \pageref{theo:#1} }
\newcommand{\Def}[1]{Definition~\eqref{def:#1} auf Seite \pageref{def:#1} }
\newcommand{\Bsp}[1]{Beispiel~\eqref{bsp:#1} auf Seite \pageref{bsp:#1} }
